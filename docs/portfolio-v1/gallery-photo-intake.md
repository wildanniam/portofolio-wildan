...
Status: **all 13 photographs are usable candidates after a lightweight derivative pass**
...
## Recommended first gallery sequence

Use a small, intentional first release instead of placing all 13 images at equal weight:

1. `ab102d36…JPG` — personal opening portrait.
2. `PHOTO-2025…JPG` — Fradium team outcome.
3. `IMG_2331.heic` — candid builder moment.
4. `IMG_7463 2.HEIC` — Nova team outcome.
5. `IMG_5499.HEIC` — academic/research milestone.
6. `FullSizeRender 5.JPG` — SpecHeal result.
7. `IMG_0313 2.HEIC` — scholarship/student-journey close.

The remaining six are ready as a second contact sheet once captions, source, and group comfort are recorded. This keeps the first gallery personal and varied while avoiding the feel of an organization résumé.
