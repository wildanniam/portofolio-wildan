...
- [GATE1_VISUAL_BOARD.md](./GATE1_VISUAL_BOARD.md) — complete checked-in target board for the hero language, Atlas, case-study opening, Moments, and motion; Wildan approval pending.
