...
export function PortfolioHomeSkeleton({
  ...
  const { currentlyBuilding, moments, profile, projects } = selection;
  const profileLinks = [
  ...
  return (
    <article className="opg-home" data-portfolio-home-skeleton>
      <SiteContainer>
        ...
        {projects.length > 0 ? (
          <section aria-labelledby="selected-work-heading" className="opg-home-section">
            <div className="opg-home-section__heading">
              <h2 id="selected-work-heading">Selected work</h2>
              <p>
                Selected build records, presented through role, system decisions, and
